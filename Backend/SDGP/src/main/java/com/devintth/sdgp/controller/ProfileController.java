...
public class ProfileController {
    ...
    public ResponseEntity<ProfileDTO> getProfile() {
        // For simplicity, fetch a default profile or modify based on your needs
        ProfileDTO profile = profileService.getProfileByUsername("default"); // Replace "default" with actual logic
        if (profile == null) {
