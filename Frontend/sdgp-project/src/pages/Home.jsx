            ...
            <div className="Homecontainer">
                <div id="grid-container1">
                    ...
                    <div className="box" id="box3">
                        ...
                        <a className="homepage-buttons" href="./Admin.jsx"><span>Check out now</span></a>
                        <h3>One on One Counseling</h3>
                        <p>Connect with expert career counselors to make informed decisions about your future.</p>
                        <a className="homepage-buttons" href="./Admin"><span>Check out now</span></a>
                        ...
                        <a className="homepage-buttons" href="./JobApply.jsx"><span>Check out now</span></a>
                    </div>
